  ...
  const album = {
    ...
    songs: [
      ...
      },
      {
        ...
        artist: "Lana Del Rey",
        image:
          "https://i.scdn.co/image/ab67616d0000b273d7fb3e4c63020039d1cff6b2",
      ...
      },
      {
        ...
        artist: "Lana Del Rey",
        image:
          "https://i.scdn.co/image/ab67616d0000b273b26b3107bdaeb0d9a4745e0a",
      ...
      },
      {
        ...
        artist: "Lana Del Rey",
        image:
          "https://i.scdn.co/image/ab67616d00001e0295e2fd1accb339fa14878190",
    ...
    <div className="h-full album">
      <div className="flex flex-row w-full mb-10 p-6 bg-footer items-center">
        ...
        <div className="h-64 ml-6 w-full flex flex-col justify-between">
          ...
          <h3 className="text-9xl text-white font-bold tracking-tight">
            {album.title}
          </h3>
          <div className="flex flex-row items-center">
            ...
            <Link to={`/artists/${artist.id}`}>
              <p className="font-semibold text-white text-[16px] whitespace-nowrap mr-1 hover:underline">
                {artist.name}
              </p>
            </Link>
            <p className="font-semibold text-white text-[16px] whitespace-nowrap mr-1">
              &#183;
            </p>
            <p className="font-semibold text-white text-[16px] whitespace-nowrap">
              {album.year}
